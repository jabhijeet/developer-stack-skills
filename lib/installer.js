...
const RULE_CONFIGS = [
  ...
  },
  {
    ...
    description: "TypeScript 5+ advanced features — conditional types, generics, Zod, exhaustiveness checking, template literal types",
    globs: ["**/*.ts", "**/*.tsx", "**/tsconfig.json"],
  },
  {
    skillName: "ci-cd",
    description: "CI/CD pipelines — GitHub Actions, GitLab CI, Jenkins for Java, Python, Node.js projects",
    globs: [".github/workflows/*.yml", ".gitlab-ci.yml", "Jenkinsfile", "**/Jenkinsfile"],
  },
  {
    skillName: "test-coverage",
    description: "Test coverage & quality metrics — JaCoCo, coverage.py, Vitest, Jest threshold configuration",
    globs: [".coveragerc", "jest.config.js", "vitest.config.ts", "**/jacoco.xml"],
  },
  {
    skillName: "security-hardening",
    description: "Security hardening — OWASP Top 10, Spring Security, secure coding patterns, cryptographic failures prevention",
    globs: ["**/*Security*.java", "**/*Config.java", "**/.env*", "**/requirements.txt"],
  },
  {
    skillName: "devops",
    description: "DevOps — Docker, Kubernetes, Terraform, Bicep, infrastructure as code, database migrations",
    globs: ["Dockerfile", "**/Dockerfile", "docker-compose.yml", "*.tf", "*.bicep", "**/*.yaml", "**/*.yml"],
  },
  {
    skillName: "graphql",
    description: "GraphQL — schema design, Java/Spring resolvers, Python/Strawberry, React/Vue clients",
    globs: ["**/*.graphql", "**/*.gql", "**/*Resolver.java", "**/*Query.py", "**/*.ts", "**/*.vue"],
  },
  {
    skillName: "documentation",
    description: "Documentation & comments — concise READMEs, method comments, docstrings, and inline comments that keep code self-explanatory",
    globs: [],
    alwaysApply: true,
  },
  {
